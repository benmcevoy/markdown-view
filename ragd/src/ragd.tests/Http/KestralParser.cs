...
//     /// </summary>
//     private int TryParseMultiSpanHeader(TRequestHandler handler, ref SequenceReader<byte> reader, out int headerLength)
//     {
//         headerLength = 0;
...
//             {
//                 return 3;//HttpParseResult.Error(RequestRejectionReason.InvalidRequestHeader, baseOffset, length);
//             }

//             headerLength = length;
//             return 0; // HttpParseResult.Complete;;
//         }
//         finally
//         {
...
//     /// </summary>
//     internal int TryParseRequestLine(TRequestHandler handler, ref SequenceReader<byte> reader)
//     {
...
//         {
//             return 2; // HttpParseResult.Complete;
//         }
